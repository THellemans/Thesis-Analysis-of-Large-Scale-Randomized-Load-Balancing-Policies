function [wloads_holder, times]=simul_mwload(d,N,lam,jtype,sp1,sp2,sp3,nruns,runlen)
...
mu=zeros(2,1);p=0;lb=0;ub=0;alpha=0;jsize=0;
if (jtype == 2)
    EX=1;
    SCV=sp1;
    f=sp2;
...
M=round(N*runlen*lam);
wloads_holder=zeros(M,nruns);
times=zeros(M,nruns);
...
for nrun=1:nruns
    ...
    while ctime < runlen
        ...
        wloads_holder(i, nrun)=mean(wloads);
        times(i, nrun)=ctime;
    end
end
