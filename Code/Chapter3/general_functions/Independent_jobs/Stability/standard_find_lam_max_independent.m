function [ lam_max ] = standard_find_lam_max_independent( d, tol,  lb, ub, Fbar0, dist_type, SCV)
%
...
elseif (dist_type == "Bounded Pareto")
	[ lam_max ] = find_lam_max_independent( d, w_range, Gbar, g, tol,  lb, ub, Fbar0);
else
	[ lam_max ] = find_lam_max_independent_PHD( d, w_range, Gbar, alpha, A, tol,  lb, ub, Fbar0);
end
